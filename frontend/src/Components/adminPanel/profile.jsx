        ...
        <header id="main-header" class="py-2 bg-primary text-white">
          <div class="container">
            <div class="row">
              <div class="col-md-6">
                <h1>
                  <FontAwesome class="fas fa-user"></FontAwesome> Edit Profile
                </h1>
              </div>
            </div>
          </div>
            ...
            <div class="row">
              ...
              <div class="col-md-3">
                <a href="#" class="btn btn-success btn-block">
                  <FontAwesome class="fas fa-lock"></FontAwesome> Change
                  Password
                </a>
              </div>
              <div class="col-md-3">
                <a href="#" class="btn btn-danger btn-block">
                  <FontAwesome class="fas fa-trash"></FontAwesome> Delete
                  Account
                </a>
              </div>
            </div>
